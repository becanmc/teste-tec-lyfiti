...
(🌍🇧🇷 To read this README in **English**, go to [README](https://github.com/becanmc/task-prioritizer/blob/main/README.md))
...
## 📜 Licença
Esse projeto está sob **Apache License 2.0**. (Mais informações vá em LICENSE ou [clique aqui](https://github.com/becanmc/task-prioritizer/blob/main/LICENSE).)

Além disso, o projeto também possui **avisos**. (Mais informações vá para NOTICE ou [clique aqui](https://github.com/becanmc/task-prioritizer/blob/main/NOTICE).)